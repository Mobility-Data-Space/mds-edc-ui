...
export const CONTEXT_SKOS = {prefix: "skos:", value: "http://www.w3.org/2004/02/skos/core#"};
export const CONTEXT_RDF = {prefix: "rdf:", value: "http://www.w3.org/2000/01/rdf-schema#"};
...
export const contextsList = [CONTEXT_DCT, CONTEXT_DCAT, CONTEXT_MOBILITYDCAT_AP, CONTEXT_MOBILITYDCAT_AP_THEME, CONTEXT_ADMS, CONTEXT_OWL, CONTEXT_SKOS, CONTEXT_RDF, CONTEXT_XSD, CONTEXT_ODRL, CONTEXT_EDC];
