import { CONTEXT_DCT, CONTEXT_DCAT, CONTEXT_OWL, CONTEXT_MOBILITYDCAT_AP, CONTEXT_MOBILITYDCAT_AP_THEME, CONTEXT_RDF, CONTEXT_SKOS, CONTEXT_ADMS, CONTEXT_EDC } from "@/jsonld/context";
...
export const ASSET_ADVANCED_INFO_GEO_REFERENCE_METHOD = `${CONTEXT_MOBILITYDCAT_AP.value}georeferencingMethod`;
...
export const ASSET_ADVANCED_INFO_REFERENCE_FILE_DESCRIPTION = `${CONTEXT_RDF.value}Literal`;
...
export const ASSET_ADVANCED_INFO_TEMPORAL_COVERAGE_START = `${CONTEXT_DCAT.value}startDate`;
export const ASSET_ADVANCED_INFO_TEMPORAL_COVERAGE_END = `${CONTEXT_DCAT.value}endDate`;
