...
import { T } from "@/i18n";
import { ASSET_ADVANCED_INFO_SOVEREIGN_LEGAL_NAME } from "@/jsonld/asset";
...
export function AssetSovereignLegalName({ translator, formData, onChange, errors }: AssetSovereignLegalNameProps): React.ReactElement {
