...
export const TRAFFIC_SIGNS_AND_SPEED_INFORMATION =
...
export type TYPE_DATA_CATEGORY =
  | typeof TRAFFIC_INFORMATION
  | typeof ROADWORKS_AND_ROAD_CONDITIONS
  | typeof TRAFFIC_FLOW_INFORMATION
  | typeof PARKING_INFORMATION
  | typeof ELECTROMOBILITY
  | typeof TRAFFIC_SIGNS_AND_SPEED_INFORMATION
  | typeof WEATHER_INFORMATION
  | typeof PUBLIC_TRANSPORT_INFORMATION
  | typeof SHARED_AND_ON_DEMAND_MOBILITY
  | typeof INFRASTRUCTURE_AND_LOGISTICS
  | typeof VARIOUS;

export const SUBCATEGORIES = {
  [TRAFFIC_INFORMATION]: ["Accidents", "Hazard Warnings"],
  [ROADWORKS_AND_ROAD_CONDITIONS]: ["Roadworks", "Road Conditions"],
  [TRAFFIC_FLOW_INFORMATION]: [
    "Realtime Traffic Flow Data",
    "Forecast Traffic Flow Data",
  ],
  [PARKING_INFORMATION]: ["Availability and Forecast", "Prices"],
  [ELECTROMOBILITY]: [
