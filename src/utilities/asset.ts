...
export const assetToAssetInput = async (asset: Asset) => {
  ...
  if (typeof auxDataAddress[ASSET_QUERY_PARAMS] === "string") {
    dataAddress.queryParams = auxDataAddress[ASSET_QUERY_PARAMS].split("&").map((queryParam: string) => {
